...
class CassandraStep(object):
    my_description = {
        'description':
        'An interface for Cassandra',
        'group': 'Simulations',
        'name': 'Cassandra'
    }
    ...
    def description(self):
        ...
        """
        return CassandraStep.my_description

    def create_node(self, flowchart=None, **kwargs):
        """Return the new node object"""
        return cassandra_step.Cassandra(flowchart=flowchart, **kwargs)

    def create_tk_node(self, canvas=None, **kwargs):
        """Return the graphical Tk node object"""
        return cassandra_step.TkCassandra(canvas=canvas, **kwargs)
